<template>
  <div class="max-w-2xl mx-auto md:pt-5">
    <ContentHeader>{{ $t("PAGES.CONTRACTS.TITLE") }}</ContentHeader>
    ...
    <section class="py-5 mb-5 page-section md:py-10">
      ...
      <button class="button-lg" @click="search">Send</button>
...
<script lang="ts">
  ...
  import { GenericSearchForm, BlockSearchForm, TransactionSearchForm, WalletSearchForm, TradeForm } from "@/components/search";
  ...
  import DeployContractForm from "@/components/search/DeployContractForm.vue";
  import ApplyContractForm from "@/components/search/ApplyContractForm.vue";
