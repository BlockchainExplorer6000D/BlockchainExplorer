<template>
  <div class="max-w-2xl mx-auto md:pt-5">
    <ContentHeader>{{ $t("PAGES.TRADES.TITLE") }}</ContentHeader>
    ...
    <section class="py-5 mb-5 page-section md:py-10">
      ...
      <button class="button-lg" @click="search">Commit</button>
    </section>
    ...
    <section v-if="submitted" class="py-5 page-section md:py-10">
      ...
      <Pagination v-if="showPagination" :meta="meta" :current-page="currentPage" @page-change="onPageChange" /></section>
  </div>
</template>
