<template>
  <div class="max-w-2xl mx-auto md:pt-5">
    <ContentHeader>{{ $t("PAGES.FILES.TITLE") }}</ContentHeader>
...
import { GenericSearchForm, BlockSearchForm, TransactionSearchForm, WalletSearchForm, FileForm } from "@/components/search";
