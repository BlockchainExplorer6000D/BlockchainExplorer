<template>
  <div id="tradeForm" class="flex flex-wrap items-center mb-10 mx-5 sm:mx-10">
    ...
    <div class="flex flex-wrap w-full justify-between">
      <div class="flex-grow w-full md:w-auto">
        <InputNumber
          :label="$t('DEPLOY_CONTRACT_FORM.CARRY_FEE')"
          name="carry_fee"
          @input="onInputChange"
          @keyup.enter.native="onEnterKey"
        />
    ...
    <div class="flex flex-wrap w-full justify-between">
      <div class="flex-grow w-full md:w-auto">
        <InputNumber
          :label="$t('DEPLOY_CONTRACT_FORM.CONTRACT_AFID')"
          name="contact_afid"
          @input="onInputChange"
          @keyup.enter.native="onEnterKey"
        />
    ...
    <div class="flex flex-wrap w-full justify-between">
      <div class="flex-grow w-full md:w-auto">
        <InputText
          :label="$t('DEPLOY_CONTRACT_FORM.VAR_AFID')"
          name="var_afid"
          @input="onInputChange"
          @keyup.enter.native="onEnterKey"
        />
...
<script lang="ts">
  ...
  export default class DeployContracatForm extends Vue {
    private input = "";
